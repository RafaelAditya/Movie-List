...
const API_KEY = 'api_key=06c811b8f8bea0dbea819766de2c1113';
    ...
    data.forEach(movie => {
        ...
        <div class="movie-details">
            ...
            <div class="detail-overview">
                <h1>${title}</h1>
                <p>${overview}</p>
                <a class="back-button" href="#form">Back</a>
            </div>
        </div>
        `

        detail_container.appendChild(movieEl);
    })
}
